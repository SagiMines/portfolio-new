...
const BackgroundCircles = () => {
  return (
    ...
    >
      ...
      <div className="border border-[#F7AB0A] opacity-20 rounded-full h-[650px] w-[650px] mt-52 absolute lg:animate-pulse animate-none" />
      <div className="border border-[#333333] rounded-full h-[800px] w-[800px] mt-52 absolute lg:block hidden" />
    </motion.div>
  );
};
